...
public class PlayerContainer {
     ...
     * @throws EntityNotFoundException Throws If no player with the given name can
     *                                 be found.
     */
    public Player findByPlayerName(String p_playerName) throws EntityNotFoundException {
        List<Player> l_filteredPlayerList = UserCoreLogic.getGameEngine().getGamePlayEngine().getPlayerList().stream()
    ...
    /**
     * Determines if a player with the specified name already exists in the list of
     * joined players.
     *
    ...
    public boolean existByPlayerName(String p_playerName) {
        return UserCoreLogic.getGameEngine().getGamePlayEngine().getPlayerList().stream()
