...
/**
 * An abstract base class for cards, enabling various actions like gaining
 * armies, spying, and airlifting in gameplay.
 * Players earn card pieces by capturing territories, effective even if
 * territories are lost later in the turn.
 *
