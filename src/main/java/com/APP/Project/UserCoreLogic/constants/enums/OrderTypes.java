...
/**
 * This enum lists all the orders which player can issue during
 * <code>issue orders</code> phase.
 * represent the command which can be entered by the player at the
 * <code>GameLoop#ISSUE_ORDER</code> phase.
 *
