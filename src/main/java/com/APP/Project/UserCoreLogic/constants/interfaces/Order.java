...
/**
 * Defines the contract for different types of orders to implement, specifying
...
public abstract class Order implements JSONable {
    /**
     * Specifies the execution sequence in the game play where this order should be
     * executed.
     */
    ...
    /**
     * Initializes a new instance of the class with the specified player as the
     * issuer of the order.
     *
    ...
    /**
     * Carries out the order in the <code>GameLoopState#EXECUTE_ORDER</code> phase
     * of the game loop.
     *
     * @throws InvalidOrderException If the order cannot be executed due to issues
     *                               like an invalid country, incorrect army count,
     *                               * or other invalid inputs.
     * @throws CardNotFoundException If the required card is not found in the
     *                               player's card list.
     */
    ...
    /**
     * Reverses the order's effects or sets the associated card to expired, undoing
     * previous execution.
     */
