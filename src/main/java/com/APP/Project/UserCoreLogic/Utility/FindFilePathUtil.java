...
public class FindFilePathUtil {
	...
	/**
	 * Retrieves the path to the user data directory as a string. This method
	 * provides access to the directory
	 * used for storing user-specific data, ensuring applications can consistently
	 * locate and use this path for
	 ...
	 *
	 * @param p_filePath The name or relative path of the file from the user data
	 *                   directory.
